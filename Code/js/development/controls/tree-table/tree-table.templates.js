...
angular.module('tree-table/templates/loading-row.tpl.html', []).run(['$templateCache', function($templateCache) {
  $templateCache.put('tree-table/templates/loading-row.tpl.html',
    '<tr class="l{{item.level+1}} tree-table-loading">\n' +
    '    <td colspan="999"><span class="loading-animation"></span>Carregando</td>\n' +
    '</tr>\n' +
    '');
}]);

angular.module('tree-table/templates/toggle-span.tpl.html', []).run(['$templateCache', function($templateCache) {
  $templateCache.put('tree-table/templates/toggle-span.tpl.html',
    '<span\n' +
